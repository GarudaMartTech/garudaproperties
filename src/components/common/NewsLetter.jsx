...
const NewsLetter = () => {
  return (
    <div className="flex flex-wrap -mt-24 bg-[#0a5076] h-fit sm:h-[250px] rounded-xl py-4 text-slate-100"
>
      ...
      <div className="flex-1 basis-[16rem] md:basis-[30rem] mt-3 sm:mt-10">
        <div className="text-center sm:text-left">
          ...
          Human-centric focus on G.E.A.L infrastructures
          </h1>
          <p>
        ...
        <div className="mt-3">
          <div className="justify-center text-black flex-align-center gap-x-2 sm:justify-start">
            ...
            />
            <button className="p-2 rounded-md bg-orange-500">
              <FiArrowRight />
            </button>
          </div>
        </div>
